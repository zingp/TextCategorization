...
if __name__ == "__main__":
    ...
    # pretrain_file = "./data/data/sgns.sogou.char"
    pretrain_file = "sgns.weibo.char"
    emb_dim = 300
    # filename_trimmed = "./data/data/embedding_SougouNews"
    filename_trimmed = "./data/embedding_Weibo"
